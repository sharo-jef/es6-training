...
TAX_RATE = 0.12; // -> エラー！ TypeError: Assignment to constant variable.</code></pre>
        ...
        exercise: {
          description:
            "<p><code>let</code>を使って<code>userName</code>という名前の変数にあなたの名前（文字列）を代入し、<code>const</code>を使って<code>birthYear</code>という名前の定数にあなたの生まれた年（数値）を代入してください。</p>",
          ...
          testFunction: (code) => {
            ...
            try {
              ...
              return {
                success: false,
                message: `コードの文法にエラーがあります: ${error.message}`,
              };
            }
            ...
            ast.body.forEach((node) => {
              if (node.type === "VariableDeclaration") {
                node.declarations.forEach((declarator) => {
                  if (
                    declarator.id.name === "userName" &&
                    node.kind === "let"
                  ) {
                    letUserNameFound = true;
                  }
                  if (
                    declarator.id.name === "birthYear" &&
                    node.kind === "const"
                  ) {
            ...
            if (!letUserNameFound) {
              return {
                success: false,
                message: "`let` を使って `userName` を宣言してください。",
              };
            }
            if (!constBirthYearFound) {
              return {
                success: false,
                message: "`const` を使って `birthYear` を宣言してください。",
              };
            }

            try {
              const func = new Function(
                code + "return { userName, birthYear };"
              );
              const result = func();
              ...
              if (
                ...
                return {
                  success: false,
                  message: "`userName`は空でない文字列である必要があります。",
                };
              }
              if (typeof result.birthYear !== "number") {
                return {
                  success: false,
                  message: "`birthYear`は数値である必要があります。",
                };
              }
            } catch (error) {
              return {
                success: false,
                message: `コードの実行中にエラーが発生しました: ${error.message}`,
              };
            }
...
console.log(result); // -> 8</code></pre>
        ...
        exercise: {
          description:
            "<p>2つの数値を引数として受け取り、それらを掛け合わせた結果を戻り値として返す<code>multiply</code>という名前の関数を、<code>function</code>キーワードを使って定義してください。</p>",
          starterCode: `// multiply関数を定義してみよう`,
          testFunction: (code) => {
            try {
              const ast = acorn.parse(code, { ecmaVersion: 2020 });
              const funcNode = ast.body.find(
                (n) =>
                  n.type === "FunctionDeclaration" && n.id.name === "multiply"
              );
              if (!funcNode) {
                return {
                  success: false,
                  message:
                    "`function`キーワードを使って`multiply`という名前の関数を宣言してください。",
                };
              }
            } catch (e) {
              return {
                success: false,
                message: `コードの文法にエラーがあります: ${e.message}`,
              };
            }
            ...
            try {
              ...
              if (typeof multiply !== "function") {
                return {
                  success: false,
                  message: "`multiply`は関数ではありません。",
                };
              }
              if (multiply(3, 4) !== 12 || multiply(-5, 10) !== -50) {
                return {
                  success: false,
                  message: "関数の計算結果が正しくありません。",
                };
              }

              return {
                success: true,
                message: "正解です！関数の基本を理解しましたね！",
              };
            } catch (error) {
              return {
                success: false,
                message: `コードにエラーがあります: ${error.message}`,
              };
            }
          },
        },
...
const double = number => number * 2;</code></pre>
        ...
        exercise: {
          description:
            "<p>引数を1つ受け取り、その数値に10を掛けた値を返すアロー関数を、<code>multiplyByTen</code>という名前の定数に代入してください。省略形を使って、できるだけ短く書いてみましょう。</p>",
          ...
          testFunction: (code) => {
            ...
            try {
              ...
              /* ignore syntax error, it will be caught by runtime check */
            }
            ...
            try {
              ...
              if (typeof multiplyByTen !== "function") {
                return {
                  success: false,
                  message: "`multiplyByTen`は関数ではありません。",
                };
              }
              ...
              if (!isArrowShortform) {
                return {
                  success: false,
                  message:
                    "アロー関数の省略形を使ってみましょう！`return`や`{}`は不要です。",
                };
              }
              return {
                success: true,
                message: "素晴らしい！簡潔に書けましたね！",
              };
            } catch (error) {
              return {
                success: false,
...
console.log(multiline);</code></pre>
        ...
        exercise: {
          description:
            "<p>定数<code>item</code>に<code>'リンゴ'</code>を、定数<code>price</code>に<code>120</code>を代入してください。その後、テンプレートリテラルを使って、<code>&lt;item&gt;の値段は&lt;price&gt;円です。</code>という文字列を作成し、定数<code>sentence</code>に代入してください。(<code>&lt;</code>, <code>&gt;</code> は含めません)</p>",
          ...
          testFunction: (code) => {
            ...
            try {
              ...
              if (sentence !== expected) {
                return {
                  success: false,
                  message: `文字列が期待通りではありません。期待する値: "${expected}"`,
                };
              }
              if (!useTemplateLiteral) {
                return {
                  success: false,
                  message:
                    "テンプレートリテラル(バッククォート ``)を使ってみましょう。",
                };
              }
              return {
                success: true,
                message: "完璧です！文字列の扱いが楽になりますね！",
              };
            } catch (error) {
              return {
                success: false,
...
user1.greet(); // -> "こんにちは、田中です。"</code></pre>
        ...
        exercise: {
          description:
            "動物を表す<code>Animal</code>クラスを定義してください。<ul><li><code>constructor</code>で<code>name</code>と<code>sound</code>を受け取り、プロパティとして設定してください。</li><li><code>speak</code>という名前のメソッドを定義し、呼び出すと<code>&lt;name&gt;は&lt;sound&gt;と鳴く</code>という形式の文字列をコンソールに出力するようにしてください。(<code>&lt;</code>, <code>&gt;</code> は含めません)</li></ul>",
          ...
          testFunction: (code) => {
            try {
              ...
              if (
                !ast.body.some(
                  (n) => n.type === "ClassDeclaration" && n.id.name === "Animal"
                )
              ) {
                return {
                  success: false,
                  message: "`Animal`という名前のクラスを定義してください。",
                };
              }
            } catch (error) {
              return {
            ...
            try {
              ...
              if (dog.name !== "ポチ" || dog.sound !== "ワン") {
                return {
                  success: false,
                  message: "constructorが正しくプロパティを設定していません。",
                };
              }
              if (typeof dog.speak !== "function") {
                return {
                  success: false,
                  message: "`speak`という名前のメソッドを定義してください。",
                };
              }
              let consoleOutput = "";
              ...
              if (consoleOutput !== expected) {
                return {
                  success: false,
                  message: `speakメソッドの出力が違います。期待する出力: "${expected}"`,
                };
              }
              return {
                success: true,
                message: "クラスを正しく定義できました！",
              };
            } catch (error) {
              return {
                success: false,
                message: `実行時エラー: ${error.message}`,
              };
            }
          },
        },
...
console.log(myDog.breed); // -> "柴犬"</code></pre>
        ...
        exercise: {
          description:
            "前の章で作成した<code>Animal</code>クラスを継承して、<code>Cat</code>クラスを作成してください。<ul><li><code>constructor</code>で<code>name</code>だけを受け取り、<code>super()</code>を使って親クラスに渡してください。</li><li><code>speak</code>メソッドをオーバーライドし、<code>&lt;name&gt;はニャーと鳴く</code>という形式の文字列をコンソールに出力するようにしてください。(<code>&lt;</code>, <code>&gt;</code> は含めません)</li></ul>",
          starterCode: `// このAnimalクラスは変更しないでください\nclass Animal {\n  constructor(name) {\n    this.name = name;\n  }\n  speak() {\n    console.log(\`\${this.name}が音を出した。\`);\n  }\n}\n\n// Animalを継承してCatクラスを定義しよう\n`,
          testFunction: (code) => {
            try {
              const ast = acorn.parse(code, { ecmaVersion: 2020 });
              const classNode = ast.body.find(
                (n) => n.type === "ClassDeclaration" && n.id.name === "Cat"
              );
              if (!classNode) {
                return {
                  success: false,
                  message: "`Cat`クラスが定義されていません。",
                };
              }
              if (
                !classNode.superClass ||
                classNode.superClass.name !== "Animal"
              ) {
                return {
                  success: false,
                  message: "`extends Animal` を使って継承してください。",
                };
              }
            } catch (error) {
              return {
            ...
            try {
              ...
              if (tama.name !== "タマ") {
                return {
                  success: false,
                  message:
                    "constructorで`name`を正しく設定できていませんか？`super(name)`を呼び出していますか？",
                };
              }
              let consoleOutput = "";
              const originalLog = console.log;
...
console.log(thirdColor); // -> "青"</code></pre>
        ...
        exercise: {
          ...
          testFunction: (code) => {
            ...
            if (!objectPatternFound)
              return {
                success: false,
                message: "オブジェクトの分割代入を使ってください。",
              };
            if (!arrayPatternFound)
              return {
                success: false,
                message: "配列の分割代入を使ってください。",
              };

            try {
              const func = new Function(
                code + "return { userName, userEmail, secondScore };"
              );
              const result = func();

              if (result.userName !== "Suzuki")
                return {
                  success: false,
                  message: "`userName`の値が正しくありません。",
                };
              if (result.userEmail !== "suzuki@example.com")
                return {
                  success: false,
                  message: "`userEmail`の値が正しくありません。",
                };
              if (result.secondScore !== 95)
                return {
                  success: false,
                  message: "`secondScore`の値が正しくありません。",
                };

              return {
                success: true,
                message: "完璧です！分割代入をマスターしましたね！",
              };
            } catch (error) {
              return {
                success: false,
    ...
    lessons: [
      {
        ...
        exercise: {
          ...
          testFunction: (code) => {
            ...
            try {
              const classDefs = new Function(
                code + "return {Product, Book};"
              )();
              const Product = classDefs.Product;
              const Book = classDefs.Book;

              const eraser = new Product("消しゴム", 100);
              if (eraser.name !== "消しゴム" || eraser.price !== 100)
                return {
                  success: false,
                  message: "Productクラスのconstructorが正しくありません。",
                };
              if (eraser.getInfo() !== "商品名: 消しゴム, 価格: 100円")
                return {
                  success: false,
                  message:
                    "ProductクラスのgetInfoメソッドの戻り値が正しくありません。",
                };
              ...
              if (
                ...
                return {
                  success: false,
                  message:
                    "Bookクラスのconstructorが正しくありません。superを呼び出していますか？",
                };
              if (
                es6Book.getInfo() !==
                "商品名: すごいES6, 著者: 山田太郎, 価格: 2500円"
              )
                return {
                  success: false,
                  message:
                    "BookクラスのgetInfoメソッドの戻り値が正しくありません。",
                };

              return {
                success: true,
                message:
                  "全問正解です！ES6の基本はマスターしましたね！素晴らしい！",
              };
            } catch (error) {
              return {
                success: false,
